...
Each case study applies the braided methods of the discipline: spatial data, public records, historical analysis, philosophical framing, community language, and system documentation — all anchored to real places, real institutions, and real people.

---

## What These Case Studies Demonstrate Together

Taken as a set, the eight documents in this folder establish three things:

1. **The problem is real and documented** — absentee ownership, extraction, and information asymmetry in Appalachia are not abstract concerns. They are measurable, mappable, and traceable to specific capital lineages operating today.
...
### Empirical and Spatial Analysis
...
| Document | What It Demonstrates |
|---|---|
| [Entangled Space after Kant and Durkheim: Toward a Polymathmatic Geography](./Entangled%20Space%20after%20Kant%20and%20Durkheim%3A%20Toward%20a%20Polymathmatic%20Geography.md) | The philosophical grounding of the discipline. Reads Kant's categories of space and time and Durkheim's collective representations as geographic theory — establishing that entangled space is not a metaphor but a rigorous philosophical claim with empirical implications. |
| [The Roman Empire Meme as Inadvertent Commons Probe](./The%20Roman%20Empire%20Meme%20as%20Inadvertent%20Commons%20Probe.md) | How a viral internet meme — the "How often do you think about the Roman Empire?" phenomenon — accidentally functioned as a real-time probe of shared cultural commons and collective memory, revealing latent geographic structures of identity and belonging invisible to standard social science instruments. |

### System Behavior and Safety Documentation
...
|---|---|
| [case_studies.md](./case_studies.md) | A comparative archive of global mutual credit systems, organized barter exchanges, and crisis credit networks — WIR Bank (Switzerland), IRTA Universal Currency, Argentina's Crédito clubs, Credit Commons, African chamas, and Quipu Market. Provides the international precedent base for MountainShares' closed-loop economic design. |
...
1. [Use Cases](./Use%20Cases.md) — what the system does for your community in plain language
2. [Absentee Ownership Concentration in Fayette County, WV](./Absentee%20Ownership%20Concentration%20in%20Fayette%20County%2C%20West%20Virginia.md) — the problem the system was built to address

**If you are an academic or researcher**, start with:
1. [Entangled Space after Kant and Durkheim](./Entangled%20Space%20after%20Kant%20and%20Durkheim%3A%20Toward%20a%20Polymathmatic%20Geography.md) — philosophical foundations
2. [case_studies.md](./case_studies.md) — the global mutual credit and commons precedent base
3. [Absentee Ownership Concentration in Fayette County, WV](./Absentee%20Ownership%20Concentration%20in%20Fayette%20County%2C%20West%20Virginia.md) — the primary empirical case

**If you are a funder or institutional partner**, start with:
1. [Use Cases](./Use%20Cases.md) — concrete outcomes
2. [Absentee Ownership Concentration in Fayette County, WV](./Absentee%20Ownership%20Concentration%20in%20Fayette%20County%2C%20West%20Virginia.md) — the documented problem and the analytical infrastructure that surfaces it

**If you are an AI safety researcher or systems designer**, start with:
1. [The PALCO False-Positive Problem](./The%20PALCO%20False-Positive%20Problem.md) — safety calibration in community contexts
2. [Prefrontal Alignment Episode](./Prefrontal%20Alignment%20Episode.md) — documented constitutional constraint performance

---

## Relationship to the Discipline and the System
...
For the full disciplinary context, see the parent folder: [discipline/README.md](../README.md)

---

*Case studies produced by Kidd's Technical Services, Inc. and authored by Carrie Ann Kidd — Mount Hope, West Virginia.*
*Polymathmatic Geography is an original discipline authored by Carrie Ann Kidd.*
