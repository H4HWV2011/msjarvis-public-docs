...
Most rural communities in Appalachia are surveyed, studied, and analyzed by outside institutions — then watched as that data, value, and decision-making power flows somewhere else. Ms. Alliss is built on a different premise:
...
**Ms. Allis is also a tool for comprehensive community planning and building infrastructure.**
...
- **Building identification and condition assessment** — Ms. Alliss maps vacant, underutilized, and historically significant buildings as candidate infrastructure nodes
...
This is the connection between the digital and physical layers of the project: **Ms. Alliss is not just software. She is a steward of place.**
...
| Host PostgreSQL + PostGIS (msAllissgis) | ✅ 5,416,522 verified beliefs |
...
├── The Ms. Allis Steward System.md   ← Plain-language steward system overview
│
...
│   ├── Government Commons Node & Ms. Alliss Partnership Overview.md
...
→ [The Ms. Alliss Steward System.md](./The%20Ms.%20Alliss%20Steward%20System.md) · [mountainshares-dao/mountainshares-dao.md](./mountainshares-dao/mountainshares-dao.md) · [the commons/Onboarding Checklists.md](./the%20commons/Onboarding%20Checklists.md)
...
→ [the commons/Government Commons Node & Ms. Alliss Partnership Overview.md](./the%20commons/Government%20Commons%20Node%20%26%20Ms.%20Alliss%20Partnership%20Overview.md) · [discipline/case_studies/Absentee Ownership Concentration in Fayette County, West Virginia.md](./discipline/case_studies/Absentee%20Ownership%20Concentration%20in%20Fayette%20County%2C%20West%20Virginia.md) · [mountainshares-dao/MountainShares DAO Governance Charter.md](./mountainshares-dao/MountainShares%20DAO%20Governance%20Charter.md)
...
1. **Trust and clarity** — Do residents, partners, and auditors find Ms. Allis more understandable and trustworthy than black-box AI or opaque government process?
...
**Harmony for Hope, Inc.** is a West Virginia nonprofit headquartered in Mount Hope, Fayette County, West Virginia. It is the institutional home of Ms. Allis, MountainShares DAO, and The Commons platform. **Kidd's Technical Services, Inc.** provides the technical development and infrastructure services.
