...
- **Project README**  
  High-level overview of the repository and its purpose.  
...
- **OpenAPI Specification**  
  ...
  → [`api_specs/openapi.json`](../api_specs/openapi.json)

- **Security Overview**  
  Summary of threat model, safeguards, and security practices.  
...
- **Source Access Policy**  
  How access to private source and deployments is managed.  
  → [`SOURCE_ACCESS.md`](../SOURCE_ACCESS.md)

- **Contributing Guide**  
  Expectations, norms, and processes for collaborators.  
  → [`CONTRIBUTING.md`](../CONTRIBUTING.md)

- **License**  
  Licensing terms for this documentation.  
  → [`LICENSE`](../LICENSE)
