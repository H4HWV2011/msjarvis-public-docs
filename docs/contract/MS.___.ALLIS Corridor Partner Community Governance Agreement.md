...
The **“MS.” prefix** in the node designation identifies this deployment as part of the **MountainShares program** operated by **Harmony for Hope, Inc.** (“H4H”), a West Virginia nonprofit corporation. Under the **MountainShares Sponsorship Tier**, H4H funds or underwrites the costs of deploying ALLIS nodes so that community and agency partners can participate **at no direct financial cost** to them. H4H is not a party to this Agreement and does not own or operate ALLIS. H4H’s role is limited to sponsoring the no‑cost deployment tier and operating the MountainShares program governance framework.
