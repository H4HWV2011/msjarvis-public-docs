...
The gateway communities of the New River Gorge National Park and Preserve face a well-documented challenge common to post-industrial Appalachian towns: historic main street buildings are held by a fragmented mix of private investors, absentee owners, and undercapitalized local stakeholders. In Mount Hope, key properties including multiple Bon-Bon buildings, a historic movie theater, a flower shop, and adjacent shell buildings along the commercial corridor are currently changing hands. Without a coordinating ownership or stewardship structure, individual investor decisions — however well-intentioned — may expose adjacent historic fabric to architectural compromise, depressing the investment value of neighboring properties and undermining corridor-level preservation goals.

This dynamic was identified directly in correspondence with David Sibray, Publisher of West Virginia Explorer Magazine, who noted that private investors Cat and Ryan, currently closing on multiple historic district properties, recognize that "their investment is endangered if other buildings are architecturally compromised." The problem is therefore not a lack of private capital interest; it is the absence of a governance and stewardship structure that aligns individual investments with corridor-wide preservation and community economic outcomes.
...
**Mechanism under consideration:** Community Land Trust (CLT)

A Community Land Trust structure would enable Harmony for Hope and regional partners to acquire and steward key historic district properties in Mount Hope and, pending feasibility analysis, in Mercer County — creating a nonprofit ownership layer that separates land value from building value, protects affordability and architectural integrity over time, and provides a governance vehicle for multi-county property management.

The CLT structure is particularly relevant given the current consolidation of property around 708 and adjacent Main Street addresses in Mount Hope. Under a CLT framework, the FCCAC building (704/708 Main Street), the proposed restaurant incubator, and potentially the geospatial company space identified for 708 could be held in a trust that prevents speculative resale while enabling community-serving uses to continue indefinitely. Governance of the CLT would include representation from both Fayette and Mercer Counties, with active outreach to Greg Puckett (Mercer County Community Connections) and potential board participation from current private investors in the historic district.

The Bank of Richmond CTFI Cohort application (due July 7, 2026) is the primary near-term financing vehicle for this layer. A Letter of Support from aligned private investors in the district would materially strengthen this application.
...
| Bank of Richmond | 2027 CTFI Cohort | July 7, 2026 | Land Stewardship (CLT) |
...
Marshall University President Brad Smith has been briefed on the initiative and has requested ongoing updates. The September 2026 deliverable to Marshall is a use case package demonstrating a live or near-live pilot deployment in Mount Hope, suitable for academic partnership, student field engagement, and potential Wing 2 Wing Foundation alignment. Brad Smith and the Wing 2 Wing Foundation have a documented focus on economic development in overlooked zip codes and entrepreneurship in Appalachian communities — a direct alignment with the corridor model this initiative is designed to prove.
...
The pattern that Mount Hope and Thurmond are proving is simple:
...
|---|---|---|
| Harmony for Hope, Inc. | Program sponsor; H4H organizational home; FCCAC site | Active |
| Kidd's Technical Services | Technical installation and system operations | Active |
...
| WV Community Development Hub (Gabe & Emma) | Grant navigation; application support; BAF and MIT/Truist referrals | Actively engaged |
| Greg Puckett / Mercer County Community Connections | Prospective CLT board member; Mercer County anchor | Networked |
...
| Cat and Ryan (private investors) | Historic district co-investors; potential CLT board members; Letter of Support opportunity | In conversation |
...
| Starry Eyes Media | Letter of Support secured | Active |
...
1. **CLT decision (by ~July 5, 2026):** Board-level determination on whether to pursue the CLT route for the Bank of Richmond application. This unlocks board recruitment (Greg Puckett, Cat/Ryan), the Letter of Support request to David Sibray's network, and the David meeting agenda.
2. **BAF submission (June 30, 2026):** Two grants to Beckley Area Foundation — broadband/operations focused. Determination expected by end of July.
3. **Bank of Richmond CTFI submission (July 7, 2026):** Contingent on CLT decision. Letter of Support from aligned investors strengthens application.
