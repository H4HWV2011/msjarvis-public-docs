...
## MIT Solve Platform
**Submission Deadline:** August 7, 2026, 12:00 PM Eastern (Noon)
...
**SOLUTION NAME** *(30-character limit)*
MountainShares Commons

**ONE-LINE SUMMARY / TAGLINE** *(150-character limit)*
Community-owned AI, local currency, and mesh connectivity helping Appalachian workers navigate the age of AI.
...
*[To be added — YouTube or Vimeo link, public or unlisted, maximum 2 minutes]*

---

### What specific problem are you solving? *(Word Limit: 200)*
...
Rural Appalachian communities — coalfield counties with poverty rates exceeding 40% in some districts, persistent broadband gaps, and generations of resource extraction — have no locally owned digital infrastructure. Every available tool for navigating benefits, finding work, or participating in the AI economy was designed by outsiders, for outsiders — and most penalize participation by threatening SNAP, SSI, or Medicaid eligibility.

Fayette County has roughly 40,000 residents. West Virginia has 33 economically distressed counties. Nationally, 43 million rural Americans face the same compounding crisis: AI is reorganizing work faster than any institution can respond, and the communities most affected have the least infrastructure to adapt.

Mount Hope is where we prove a different model is possible. The New River Gorge corridor — 53 miles, seven gateway communities, a National Park, and no reliable cell service — is where it scales.

---

### What is your solution? *(Word Limit: 200)*

MountainShares Commons is a community-owned economic and intelligence platform currently in Phase 0 red team testing in Mount Hope, West Virginia, June 2026.
...
**The Commons** is the governed marketplace, resource navigator, and community platform where residents earn, spend, connect, and shape the system itself.

Mount Hope is where we prove it works. The New River Gorge corridor — 53 miles, seven gateway communities, a National Park, and no reliable cell service — is where it scales.

Platform: egeria.mountainshares.us/commons

---

### Who does your solution serve? *(Word Limit: 200)*

MountainShares Commons serves residents of Mount Hope and the New River Gorge corridor — rural Appalachian communities where poverty, infrastructure disinvestment, and geographic isolation compound daily. Nearly 1 in 4 residents lives below the poverty line. Broadband is limited. Public transit is nonexistent. Trust in outside institutions is low, and earned.

Four overlapping groups are directly served:

- **Benefits recipients** on SNAP, SSI, and Medicaid who need economic participation tools that don't trigger eligibility cliffs — addressed through Benefits-Sensitive Account architecture built into the platform's core
- **Caregivers and volunteers** whose labor sustains the community but goes unrecognized and uncompensated by the formal economy
- **Small local businesses** with no community-anchored alternative to extractive retail and e-commerce
- **Residents navigating systems** — housing, health, workforce, emergency resources — without reliable, local, trustworthy information

Ms. Allis closes the information gap: accurate, place-specific, surveillance-free answers. MountainShares closes the economic gap: dignified participation without benefits penalties. The Commons closes the civic gap: a governed space residents actually own.

As the corridor scales, every gateway community gains the same locally owned infrastructure — on their own terms.

---

## SECTION 2: YOUR ELIGIBILITY

| Question | Answer |
|---|---|
| Registered 501(c)(3) with the IRS? | YES |
| 509(a)(3) supporting organization? | NO |
| Fiscal agent? | NO |
| Stage of development? | GROWTH |
| Communities within Truist footprint? | West Virginia |

**GROWTH** — Registered 501(c)(3) with an established product rolled out in one community, poised for further growth. Proven track record with an annual operating budget.

---

## SECTION 3: SOLUTION OVERVIEW & TEAM LEAD DETAILS

**CHALLENGE DIMENSION**
→ Additional Wraparound Services and Basic Needs Support

**SOLUTION STAGE OF DEVELOPMENT**
→ PROTOTYPE
*(Phase 0 invite-only red team testing underway; first external users onboarded. System is functioning but not yet in consistent community-wide availability.)*

---

### Why you selected PROTOTYPE — what has been built and tested *(Word Limit: 200)*
...
- Phase 0 invite-only red team testing underway with first external users onboarded June 2026

Academic validation from Dr. Anurag K. Srivastava, Raymond J. Lane Professor and Chair, WVU Lane Department of Computer Science and Electrical Engineering. Belief state containers track probabilistic status, risk, and capacity per entity, forming the foundation for Bayesian updates and temporal decay across the full geospatial graph.
...
**The theoretical physics and computer science communities have been trying to build this from the top down for decades. We built it from the bottom up because a community needed it to work on Tuesday.**
The result is a formally verified, computationally operational system where Hilbert space geometry, spatial reference frames, observer-dependent states, and Bayesian temporal decay operate simultaneously on 26.9 million real-world features. The architecture's validity is proven independent of its outputs — the mathematical structure is the discovery, not the application layer running on top of it. This is not a toy dataset or a controlled research environment. The constraints were imposed by reality: roads without addresses, parcels with conflicting records, communities where data goes stale faster because they are underserved. Those constraints forced honesty that top-down theoretical work never has to confront. The sandbox that quantum gravity theorists and information geometers have been trying to design from first principles exists. It was built in a coalfield town, for $600 cash, by someone who needed it to serve her neighbors.
...
**Community ownership is implemented as enforceable infrastructure.**
Governance, data stewardship, and economic rules are constitutionally constrained and democratically auditable. Residents can inspect, challenge, and deactivate components that conflict with local intent. West Virginia's standardized public geospatial data and history of outside extraction make it an ideal proving ground before this model travels — to every rural county, every heritage corridor, every community where platform monopolies have captured local markets and black-box AI has replaced local accountability.

Mount Hope proves it. The New River Gorge corridor scales it. Appalachia exports the blueprint.

---

### Theory of change *(Word Limit: 300)*

MountainShares Commons is designed to change outcomes for rural residents by aligning three systems that usually work against them: information, income, and institutions.

The core problem is structural. People in Mount Hope and the New River Gorge corridor navigate housing, work, health, and benefits with fragmented information, no safe way to earn supplemental value, and limited local control over the tools that shape their lives. Each gap reinforces the others.

**Activity 1 — Deploy Ms. Allis as a locally grounded intelligence layer.**
She organizes public geospatial data, community knowledge, and verified datasets into a place-based system that answers natural-language questions about real parcels, roads, services, and programs. The immediate output is accurate, traceable, surveillance-free guidance that works without reliable cellular coverage. The expected outcome is reduced information gaps that prevent residents from accessing opportunities and supports they already qualify for. Research on digital navigation tools in comparable communities shows that clear, trusted, locally controlled information measurably increases program uptake and reduces administrative burden on both residents and service providers.

**Activity 2 — Launch MountainShares with account protections built into the ledger.**
Residents earn local value for caregiving, volunteering, and community contribution without risking existing program eligibility. The output is a functioning closed-loop exchange anchored in local businesses and nonprofits. The expected outcome is greater recognition of invisible labor, more local circulation of value, and reduced reliance on predatory financial products. Timebank and mutual credit studies in other communities show that even small, well-governed local exchange systems increase social cohesion and perceived economic security.
...
### How are you and your team well-positioned? *(Word Limit: 300)*
...
The Benefits-Sensitive Account architecture wasn't born from research — it was born from watching two Harmony for Hope members lose SSI benefits because an AmeriCorps stipend counted as unearned income. The program designed to reward their service took their stability instead. MountainShares was engineered from the ground up so that never happens here.
...
- [x] Big Data
- [x] Blockchain
- [x] Crowd Sourced Service / Social Networks
- [x] Generative Artificial Intelligence (AI)
- [x] Geographic Information Systems (GIS) and Geospatial Technology
- [x] Machine Learning
- [x] Software and Mobile Applications

---

**HOW MANY BENEFICIARIES DOES YOUR SOLUTION CURRENTLY SERVE?**
→ 1–10

**IS PARTICIPATION LIMITED BY RACE, COLOR, RELIGION, SEX, SEXUAL ORIENTATION, GENDER IDENTITY, OR NATIONAL ORIGIN?**
→ NO

**DOES YOUR SOLUTION HAVE A WEBSITE, APP, OR SOCIAL MEDIA HANDLE?**
→ YES
...
### Why are you applying to the Truist Foundation Inspire Awards? *(Word Limit: 200)*

MountainShares Commons is community-owned economic and intelligence infrastructure for coalfield Appalachia. We are applying because we need what capital alone cannot buy: credibility, peer network, and structured capacity-building at the exact moment our regional coalition is forming.

Truist Foundation's place-based focus aligns precisely with our model. Semifinalist capacity-building resources — consultants, subject matter experts, and peer cohort access — would directly address our most urgent gaps: impact measurement, partnership formalization, and corridor scaling strategy.
...
**MITx COURSE COMPLETED?** → NO

**HOW DID YOU HEAR ABOUT THE CHALLENGE?**
Referred by Gabe Peña, WV Community Development Hub, and a former AmeriCorps supervisor — both connected since the project's origin in the Fayette County Coordinator's Office.

---

## SECTION 4: YOUR TEAM

### How many people work on your solution team? *(Word Limit: 100)*
...
### How long have you been working on your solution? *(Word Limit: 100)*
...
## SECTION 5: YOUR BUSINESS MODEL & FUNDING

### What is your business model? *(Word Limit: 300)*

MountainShares is a community-owned economic infrastructure system for Appalachian West Virginia, operated by Harmony for Hope, Inc., a nonprofit based in Mount Hope, WV. Our model has two integrated layers: a dual-currency local marketplace (The Commons) and a locally hosted AI navigation system (Ms. Allis).
...
### What is your plan for becoming financially sustainable? *(Word Limit: 300)*
...
### What was your organizational budget for FY2025 & FY2026? *(Word Limit: 150)*
...
### How is your current budget allocated? *(Word Limit: 150)*
