...
- a founder capital account,
- membership units or restricted membership units,
- profits interests,
- phantom equity,
- a subordinated founder note,
- a contingent revenue participation right,
- or another legally permitted private founder instrument.

Unless and until the final form is selected, this Agreement expresses the economic intent of the Founder Capital Value and does not fix the final tax classification or securities treatment of the instrument.
...
Deferred founder capital is contingent, phased over time, and not payable as a lump sum. Consistent with that structure, no payment, redemption, repurchase, or founder distribution under this Agreement may occur before the trigger conditions expressly adopted in the final executed version.

The final executed version shall incorporate the following principles:

- No lump-sum extraction.
- No payment sourced from participant EMS balances.
- No payment sourced from H4H charitable assets.
- No payment mechanism routed through EMS conversion logic.
- Any founder return shall occur, if at all, through KTS-side economics, KTS-side books, and counsel-approved mechanics.

The final instrument may use milestone vesting, time vesting, profitability thresholds, revenue thresholds, board approval gates, or a combination thereof, provided that the mechanism remains outside EMS and outside H4H-administered charitable flows.
...
- KTS operating revenue,
- KTS financing proceeds,
- KTS profit allocations,
- KTS capitalization events,
- KTS sale or liquidity events,
- or other lawfully available KTS funds.

## 9. Intellectual property and related agreements

This Agreement may be paired with one or more separate agreements governing:
...
No final execution of this Agreement shall occur until all of the following have occurred:
...
This Agreement shall be governed by and construed under the laws of the State of West Virginia, except to the extent federal tax, securities, nonprofit, or other federal law controls a specific issue.

## 15. Future entity conversion
