...
**Multi-Year Extension Notice:** This Change of Scope Request extends the engagement beyond the original September 25, 2025 contract end date to **November 27, 2028**. This extension is intentional and necessary. The revised schedule accommodates the time required to pursue grant funding, build organizational capacity, hire staff, procure hardware, and execute a live physical ALLIS deployment at the reference implementation site. The extended timeline is a feature of responsible commons development — not a delay. No phase of this work proceeds faster than the funding, staffing, and governance infrastructure required to sustain it.
...
| MS.MHHWT.ALLIS Corridor Partner Agreement | Drafting of the MHHWT-specific Corridor Partner Agreement between H4H (as program sponsor) and the City of Mount Hope / MHHWT governance body |
| Node Deployment Record | Documentation of the initial three-node cluster as the MS program reference implementation |
| Integration with Existing Trail Infrastructure | Coordination with Clio app integration and existing trailhead kiosk for interpretive continuity |
| End-Product Delivery & Handoff | Delivery of a functional, documented ALLIS deployment with operator runbook and transition materials |

### 3b. Work Unchanged

All original MountainShares / The Commons framework deliverables, governance instruments, and Corridor Partner agreement templates remain in scope and on their original internal milestones. This change of scope adds to — and does not replace — any previously agreed deliverable.
...
|-----------|--------------|--------------|
| Framework & Governance Deliverables | September 25, 2025 | September 25, 2026 *(extended to accommodate grant funding and staffing)* |
...
| End-Product Delivery & Handoff | September 25, 2025 | **November 27, 2028** |

**Note on Schedule:** The multi-year schedule between 2026 and 2028 reflects the realistic timeline for a nonprofit-led, grant-funded commons infrastructure project in a rural Appalachian context. Grant applications, award cycles, hiring, procurement lead times, and site preparation all require time that cannot be compressed without compromising quality or governance integrity. The schedule is not aspirational — it is the minimum responsible timeline for doing this work correctly.
...
5. The revised schedule is contingent on successful grant funding. If funding timelines shift, milestone dates may be adjusted by mutual written agreement without requiring a new Change of Scope Request, provided the revised end date does not extend beyond December 31, 2029.

---

## 7. Acknowledgment and Authorization

By signing below, both parties agree to the scope changes, revised schedule, multi-year extension, and conditions described in this document. This Change of Scope Request becomes a binding amendment to the original agreement upon execution by both parties.
