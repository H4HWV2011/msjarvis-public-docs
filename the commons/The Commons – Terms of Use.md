...
2.1 **Eligibility.** The Commons is intended primarily for individuals and organizations located in the State of West Virginia, although some features may be viewable more broadly. You must be at least 18 years old (or the age of majority in your jurisdiction, if higher) to create an account.

2.2 **Account Registration.** To use certain features, you must register for an account and provide accurate, current information. You agree to keep this information up to date.

2.3 **Account Security.** You are responsible for maintaining the confidentiality of your login credentials and for all activities that occur under your account. You agree to notify us promptly of any suspected unauthorized access or breach of security.

2.4 **Relationship to UEI.** The Platform may associate your account with one or more Unique Ecosystem Identifiers (UEIs) used for governance and rewards tracking. Additional conditions around UEIs and MountainShares governance are set out in the DAO and Rewards Program documents.

---

## 3. Platform Description and Relationship to MountainShares
...
3.3 **No Financial Institution.** The Commons is not a bank, credit union, money transmitter, or investment platform. Any payment functionality is provided via third‑party processors under their own terms. Use of MountainShares within The Commons does not create a deposit account or investment relationship with Harmony for Hope.
...
5.1 **User Content.** You retain ownership of content you create and post on The Commons, including text, images, videos, and other materials, subject to any licenses granted in this section.

5.2 **License to Harmony for Hope.** By posting or submitting User Content, you grant Harmony for Hope a non‑exclusive, worldwide, royalty‑free license to use, host, store, reproduce, modify, adapt, publish, display, and distribute such content solely for purposes of operating, improving, and promoting The Commons and related community programs, subject to the Privacy Policy and Applicable Law.
...
6.1 The Commons may integrate with or link to third‑party services (for example, payment processors, mapping services, CLIO, or external educational platforms). Use of those services is governed by their own terms and policies.

6.2 Harmony for Hope is not responsible for the content, security, or practices of third‑party sites and services, and does not endorse or control them unless explicitly stated.

---

## 7. Data, Privacy, and Security

7.1 **Privacy Policy.** Our separate **Privacy Policy** describes what information we collect, how we use it, and your choices. The Privacy Policy is incorporated by reference into these Commons Terms.

7.2 **Security.** We employ reasonable technical and organizational measures to protect the Platform and associated data but cannot guarantee perfect security. You use The Commons at your own risk.

7.3 **Data Sharing.** Data may be shared with service providers, regulators, or law‑enforcement authorities as allowed or required by law and as described in the Privacy Policy.
...
9.3 **Limitation of Liability.** To the maximum extent permitted by law, Harmony for Hope and its officers, directors, employees, and volunteers will not be liable for any indirect, incidental, consequential, special, or punitive damages arising out of or relating to your use of The Commons.
...
11.1 These Commons Terms are governed by the laws of the State of West Virginia and applicable federal law, without regard to conflict‑of‑law principles.

11.2 Any disputes arising out of or relating to these Commons Terms or The Commons will be resolved in forums and through processes to be specified in consultation with legal counsel (for example, mediation followed by state or federal courts located in West Virginia).
