...
**Version:** 1.0  
**Date:** April 18, 2026  
**Status:** Draft — Founding Cohort Review  
**Related Documents:** [MountainShares Funder Overview](./MountainShares%20Funder%20Overview%20.md), [Phase 0 Specification](./MountainShares%20Phase%200%3A%20Invite-Only%20Beta%20Specification.md), [Phase 1 Specification](./MountainShares%20Phase%201%3A%20Economic%20Safety%20Specification.md), [Phase 2 Specification](./MountainShares%20Phase%202%3A%20Regional%20Growth%20Specification.md), [Phase 3 Specification](./MountainShares%20Phase%203%3A%20Surplus%20Distribution%20Specification.md), [KPI Specification](./MountainShares%20KPI%20Specification.md)
...
Here is why. Every time a MountainShares balance changes hands inside the closed loop — member to merchant, merchant to supplier, supplier back to member — fees accrue to the treasury. A single dollar that circulates ten times inside the system generates ten times the reserve inflow of a dollar that loads once and sits.

This is the closed-loop advantage. Value that stays inside MountainShares builds the reserve with every transaction. Value that leaks out — to Amazon, to out-of-state chains, to extractive platforms — builds nothing for the community.

**Healthy growth is circulation growth, not account growth.** The KPI that matters most in Phase 0 and Phase 1 is not registered users — it is **average transaction velocity per active M$ in circulation**.

---

## 2. Phase 0 — Proof of Circulation (Mount Hope)

**Geographic scope:** 706 Main Street, Mount Hope, WV and immediate Fayette County anchor community  
...
**Reserve target:** Demonstrate sustained 100%+ reserve ratio for 90 consecutive days  
...
Success in Phase 0 is not a user count. It is a **circulation record** — documented evidence that M$ moved between real people and real merchants, that the reserve grew, and that the safety architecture protected benefits-sensitive participants without restricting their participation.

The ALLIS node cluster at 706 Main Street and the Mount Hope Historic Walking Trail trailhead kiosk is the physical infrastructure of Phase 0 — the proof that the system exists in the world, not just in documentation.

---

## 3. Phase 1 — Local Economic Safety Net (Fayette County)

**Geographic scope:** Fayette County, WV — anchored in Mount Hope, extending to Oak Hill, Fayetteville, and surrounding communities  
**Target active participants:** 500 – 2,000  
**Target merchants:** 30 – 75  
**Reserve target:** Sustained 150%+ reserve ratio  

Phase 1 growth is merchant-led, not member-led. The reserve grows fastest when merchants participate — every merchant transaction generates 1.80% in fees, 30% of which flows directly to the treasury. A merchant doing $10,000/month in MountainShares transactions contributes $54/month to the reserve automatically, every month, without any additional action.

**Phase 1 merchant priority list:**

- Daily necessity businesses: groceries, pharmacies, hardware, fuel
...
## 4. Phase 2 — Regional Corridor Growth (New River Gorge and Southern WV)
...
**Target active participants:** 15,000 – 40,000  
**Target merchants:** 300 – 800  
**Reserve target:** Sustained 300%+ reserve ratio at $10/M$ internal schedule  

Phase 2 growth is network-led. The reserve threshold for Phase 2 activation — 300% at the $10/M$ internal schedule — requires not just transaction volume but **inter-community circulation**. Value that moves between Mount Hope and Beckley, between Fayetteville and Welch, between trail corridor communities and their suppliers, compounds the reserve faster than any single-node economy can.
...
**Phase 2 growth is also AppalachianShares groundwork.** The governance architecture, the merchant onboarding playbook, the ALLIS deployment methodology, and the KPI framework proven in Phase 1 become the replication package for every subsequent corridor. Phase 2 is not just regional growth — it is the documentation of how to do this again.

---

## 5. Phase 3 — Statewide and Diaspora (West Virginia + WV Diaspora Network)

**Geographic scope:** West Virginia statewide + WV diaspora nationally  
**Target active participants:** 200,000 – 400,000  
**Target merchants:** 3,000 – 8,000  
**Reserve target:** Sustained 500%+ reserve ratio at $34.70/M$ internal schedule  
...
**The 384,000 consumer threshold for Phase 3 sustainability is not a West Virginia number. It is a diaspora number.** West Virginia's in-state population cannot alone sustain a 500% reserve at the $34.70/M$ internal schedule. The diaspora — and the broader national market for authentic Appalachian goods and place-based economic solidarity — is what makes Phase 3 mathematically viable.
...
## 6. What Unhealthy Growth Looks Like
...
**Sybil and dividend farming attacks** at Phase 3 scale are addressed in the Phase 3 Specification's safety prohibitions. The participation-weight formula rewards sustained presence, not account multiplication.

---

## 7. The Growth Compact
...
*MountainShares Growth Thesis — Harmony for Hope, Inc. — Mount Hope, West Virginia*  
*Authored and designed by Carrie Ann Kidd / Kidd's Technical Services, LLC*  
*See LICENSE for terms.*  
*This document is not legal, tax, or investment advice.*
