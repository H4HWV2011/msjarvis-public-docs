...
This specification operationalizes the principles of Polymathmatic Geography for the Appalachian economic commons across the full phased rollout of MountainShares.

- **Every where is entangled / leakage and enclosure.** Sections 1 through 4 treat monetary health, participation, usefulness, and impact as coupled dimensions of a single regional system, rather than isolated metrics.
- **Transparency and traceability.** The implementation and dashboard guidelines in Section 8 translate abstract KPIs into concrete, inspectable time-series tied to real users, organizations, and regions.
- **Power accountable to place.** Targets and trends across all four phases are intended to guide governance decisions and parameter changes, making institutional power responsive to how the system behaves in specific Appalachian communities.

Anti-leakage and closed-loop spending are measured directly through monetary-health and local-loop KPIs (1.1 through 1.3 and 4.1), which track circulation, concentration, and local hops to detect value leakage and to confirm the strength of the closed loop. Value-interaction and commons-work KPIs (3.2 and 3.3) provide quantitative anchors for designing bounties, quests, and corrective programs when participation or impact falls short of the targeted ranges.
...
The MountainShares rollout progresses through four operational phases, each with distinct geographic scope, participant scale, and structural function:

| Phase | Target Year(s) | Geographic Scope | End-of-Period Participants | Strategic Function |
|---|---|---|---|---|
| Phase 0 | 2026 (Year 1) | Mount Hope; FCCAC anchor | ~100 (invite-only) | Pilot and red-team validation |
| Phase 1 | 2027 (Year 2) | Fayette County | ~2,000 | County-scale public rollout |
| Phase 2 | 2028 (Year 3) | New River Gorge corridor + southern WV | ~40,000 | Regional corridor expansion |
| Phase 3 ramp | 2029 (Year 4) | Statewide push | ~175,000 | Statewide adoption begins |
| **Phase 3 threshold** | **2030 (Year 5)** | **Statewide + diaspora** | **~315,800** | **Inner-core sustainability reached** |
| Phase 3 safety margin | 2031 (Year 6) | Statewide + diaspora | ~383,000 | Margin-of-safety target |
| Phase 3 mature | 2032+ | Statewide + diaspora | 400,000+ | Steady-state operations |

The inner-core threshold of approximately 315,800 active participants is the level at which the 500% reserve floor becomes structurally sustainable through the combined inflows of transaction fees, diaspora premium, federal and foundation grants, and the founder's in-kind match. The margin-of-safety target of approximately 383,000 provides operational headroom against shock and seasonal variation. Phase 3 mature operations target 400,000 or more participants with up to 8,000 active merchants statewide and significant West Virginia diaspora engagement through the USD storefront.

---

## 1. Monetary Health KPIs
...
| Phase | Year | Target Velocity (monthly) |
|---|---|---|
| Phase 0 | 2026 | ≥ 0.5 |
| Phase 1 | 2027 | ≥ 1.0 |
| Phase 2 | 2028 | ≥ 1.5 |
...
**Definition.** Median number of on-chain or logged transactions per active user per month. An active user is defined as a user who has completed at least one verified task and at least one transaction in the last 30 days.

| Phase | Year | Target Transactions/Active User/Month |
|---|---|---|
| Phase 0 | 2026 | ≥ 2 |
| Phase 1 | 2027 | ≥ 4 |
| Phase 2 | 2028 | ≥ 6 |
...
| Phase | Year | Target Concentration (top 10) |
|---|---|---|
| Phase 0 | 2026 | ≤ 60% |
| Phase 1 | 2027 | ≤ 40% |
| Phase 2 | 2028 | ≤ 30% |
...
**Definition.** Number of users with at least one verified task and one transaction in the last 30 days, divided by total registered users in the region.

| Phase | Year | Target MAU Rate |
|---|---|---|
| Phase 0 | 2026 | ≥ 60% |
| Phase 1 | 2027 | ≥ 30% |
| Phase 2 | 2028 | ≥ 40% |
...
| Phase | Year | Target Activation Rate |
|---|---|---|
| Phase 0 | 2026 | ≥ 80% |
| Phase 1 | 2027 | ≥ 40% |
| Phase 2 | 2028 | ≥ 50% |
...
|---|---|---|
| Phase 0 | 2026 | 5–15 |
| Phase 1 | 2027 | ≥ 30 (target range 30–75) |
...
**Definition.** Total verified hours of commons, cultural, mutual-aid, caregiving, and similar qualifying work compensated in MountainShares per month in the live region.

| Phase | Year | Target Commons Hours/Month |
|---|---|---|
| Phase 0 | 2026 | ≥ 100 |
| Phase 1 | 2027 | ≥ 1,000 |
| Phase 2 | 2028 | ≥ 5,000 |
...
Phase 0 establishes the operational foundation for everything that follows. The 25 to 100 invite-only participants are conscious testers — researchers, Community Champions, merchants, and institutional partners who serve as the red team for the entire system. Their role is to identify failure modes in the economic geometry, the identity system, the Benefits-Sensitive Account architecture, and the judge pipeline before the system opens to wider public enrollment.
...
- Pre-launch audit report completed (Q4 2026).
...
| Variable | Value |
|---|---|
| Average participants over year | ~50 |
| Avg monthly load per participant | ~$50 |
| Annual M$ loaded | ~$30,000 |
| Load fee revenue (2.85%) | ~$855 |
| Merchant fee revenue (1.80% × velocity 0.5) | ~$270 |
| Internal transfer fees | ~$50 |
...
- Commons Phase 1 public launch (Q1–Q2 2027).
- 500 to 2,000 active participants enrolled.
- 30 to 75 merchants integrated.
...
| Variable | Value |
|---|---|
| Average participants over year | ~1,000 |
| Avg monthly load per participant | ~$75 |
| Annual M$ loaded | ~$900,000 |
| Load fee revenue (2.85%) | ~$25,650 |
| Merchant fee revenue (1.80% × velocity 1.0) | ~$16,200 |
| Internal transfer fees | ~$500 |
...
- Thurmond ALLIS node operational (Q1 2028).
- Money Transmitter License application filed (Q1 2028); MTL secured (Q3–Q4 2028).
- Surety bond posted ($300,000).
- Additional gateway nodes operational at Fayetteville, Oak Hill, Hinton, and Ansted (Q2–Q4 2028).
...
| Variable | Value |
|---|---|
| Average participants over year | ~20,000 |
| Avg monthly load per participant | ~$100 |
| Annual M$ loaded | ~$24,000,000 |
| Load fee revenue (2.85%) | ~$684,000 |
| Merchant fee revenue (1.80% × velocity 1.5) | ~$648,000 |
| Internal transfer fees | ~$5,000 |
...
**Target End-of-Year Participants.** ~175,000.
**Target Merchants.** ~1,500.

**Key Activities and Milestones**

- Statewide outreach campaign launched.
...
| Variable | Value |
|---|---|
| Average participants over year | ~100,000 |
| Avg monthly load per participant | ~$115 |
| Annual M$ loaded | ~$138,000,000 |
| Load fee revenue (2.85%) | ~$3,933,000 |
| Merchant fee revenue (1.80% × velocity 1.7) | ~$4,222,800 |
| Internal transfer fees | ~$25,000 |
...
**Target End-of-Year Participants.** ~315,800 (inner-core sustainability threshold).
**Target Merchants.** ~2,500.
...
| Variable | Value |
|---|---|
| Average participants over year | ~245,000 |
| Avg monthly load per participant | ~$130 |
| Annual M$ loaded | ~$382,200,000 |
| Load fee revenue (2.85%) | ~$10,892,700 |
| Merchant fee revenue (1.80% × velocity 1.9) | ~$13,067,000 |
| Internal transfer fees | ~$50,000 |
...
| Variable | Value |
|---|---|
| Average participants over year | ~349,400 |
| Avg monthly load per participant | ~$140 |
| Annual M$ loaded | ~$586,900,000 |
| Load fee revenue (2.85%) | ~$16,726,650 |
| Merchant fee revenue (1.80% × velocity 2.0) | ~$21,128,400 |
| Internal transfer fees | ~$75,000 |
...
|---|---|
| Sustained participants | 400,000+ |
| Avg monthly load per participant | ~$150 |
| Annual M$ loaded | ~$720,000,000 |
| Load fee revenue (2.85%) | ~$20,520,000 |
| Merchant fee revenue (1.80% × velocity 2.0) | ~$25,920,000 |
| Internal transfer fees | ~$100,000 |
...
| Year | Phase | Avg Participants | Total Fee Revenue | To Treasury Reserve | To H4H Operations |
|---|---|---|---|---|---|
| 2026 | Phase 0 | ~50 | ~$1,175 | ~$353 | ~$353 |
| 2027 | Phase 1 | ~1,000 | ~$42,350 | ~$12,705 | ~$12,705 |
| 2028 | Phase 2 | ~20,000 | ~$1,337,000 | ~$401,100 | ~$401,100 |
| 2029 | Phase 3 ramp | ~100,000 | ~$8,180,800 | ~$2,454,240 | ~$2,454,240 |
| 2030 | Phase 3 threshold | ~245,000 | ~$24,009,700 | ~$7,202,910 | ~$7,202,910 |
| 2031 | Phase 3 safety margin | ~349,400 | ~$37,930,050 | ~$11,379,015 | ~$11,379,015 |
| 2032+ | Phase 3 mature | 400,000+ | ~$46,540,000 | ~$13,962,000 | ~$13,962,000 |

All projections assume conservative-to-moderate adoption rates within the published phase ranges. Actual performance will be reviewed quarterly and the projections revised as live data accumulates.
...
Cumulative reserve contribution from fees alone, by end of each phase:

| Through End of | Cumulative Reserve Contribution from Fees |
|---|---|
| Phase 0 (2026) | ~$353 |
| Phase 1 (2027) | ~$13,058 |
| Phase 2 (2028) | ~$414,158 |
| Phase 3 ramp (2029) | ~$2,868,398 |
| Phase 3 threshold (2030) | ~$10,071,308 |
| Phase 3 safety margin (2031) | ~$21,450,323 |

Fee revenue alone is structurally insufficient to fund the full $300 million reserve target. The remaining requirement is filled by the three streams below.

**Stream 2: Diaspora Premium (Appalachian Premium on Authentic Goods)**

The estimated 200,000+ West Virginia diaspora is the primary source of structural reserve growth beyond fee revenue. The USD storefront sells authentic Appalachian-made goods at a premium that flows directly into the treasury reserve. Conservative estimates: 50% of diaspora participates (~100,000 households), averaging $200/year in premium-supporting purchases, generating ~$20 million per year in reserve contribution from Phase 3 ramp forward.

**Stream 3: Federal and Foundation Grants**

Targeted grant programs aligned with phase progression:

- Appalachian Regional Commission (Area Development, Partnerships for Opportunity)
- USDA Rural Development (ReConnect, Community Facilities)
- Department of Energy (Rural and Remote Communities, AI for Rural Communities)
- National Park Service (Heritage Preservation, partner program funding)
...
When all four streams converge through Phase 3 ramp and Phase 3 threshold, the reserve floor of 500% becomes structurally sustainable. The threshold year (2030) is defined as the point at which ongoing reserve contribution (across all streams) exceeds reserve depletion from M$ creation, sustaining the 500% ratio in steady state.
