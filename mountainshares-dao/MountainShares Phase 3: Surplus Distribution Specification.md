...
- Queued Regulatory Compliance Draws: $85,000
...
Distributions are issued in one of three forms, elected by the participant:
...
- **USD cash-out (optional):** Available for UEIs who choose to convert their distribution to USD within 90 days of distribution, subject to applicable fees and Benefits-Sensitive Account protections. After 90 days, unclaimed USD elections revert to M$ credit.
- **EMS Recognition Bonus (optional):** The participant elects to convert their distribution into permanent EMS recognition hours rather than M$ or USD. This option locks the value into the recognition ledger permanently and cannot be reversed. It does not count as income or assets for any purpose — it is a recognition record only. Particularly appropriate for Benefits-Sensitive Account holders who wish to preserve their benefits eligibility while still receiving credit for their contribution to the commons.
...
## 7A. Regulatory Compliance Reserve Draw (H4H Operational Authority — Phase 3)
...
3. Any remaining surplus above the 500% floor after full M$ redemption and regulatory draw settlement is distributed to all then-eligible UEIs using the participation-weight formula
