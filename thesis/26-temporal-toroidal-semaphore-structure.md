...
> As such, this chapter belongs to the **Computational Instrument** tier: it formalizes how temporal, cyclical, and gated structures shape Ms. Jarvis’s conscious processing.

# 26. Temporal, Toroidal, and Semaphore Structure of Conscious Processing

This chapter refines three complementary structural views of the processes described in Part IV and implemented in the live system. Temporal, toroidal, and semaphore perspectives describe how the same components behave over time, how they recirculate information, and how they regulate activity under load and risk. Together, these views connect abstract design to concrete services such as the unified consciousness pipeline, Chroma- and GeoDB-backed memory, autonomous learning, and concurrency control at the AI server. The use of temporal scales, recurrent loops, and resource gates mirrors wider ideas in dynamical and modular AI systems, such as Goyal et al.’s modular control perspective (https://arxiv.org/abs/2103.01197) and Battaglia et al.’s graph-based dynamics (https://arxiv.org/abs/1806.01261).
